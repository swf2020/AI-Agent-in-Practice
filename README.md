...
| 目录 | 许可证 |
|------|--------|
| `/libs/` | [MIT License](libs/LICENSE) |
| `/docs/` | [CC BY-NC-SA 4.0](docs/LICENSE) |
| 根目录配置文件 | [Apache License 2.0](LICENSE) |

### 许可证说明

- **MIT License**（代码）：允许自由使用、复制、修改、合并、发布、分发、授权和/或销售软件副本，只需保留版权声明和许可声明。

- **CC BY-NC-SA 4.0**（文档）：允许非商业使用、共享和改编，但必须署名原作者，且改编作品需采用相同许可证。

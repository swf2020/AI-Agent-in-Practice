...
timeline
    ...
    2022 : InstructGPT 论文发布 : RLHF 证明小模型经过偏好对齐可优于未对齐大模型
    2022 : Constitutional AI 论文发布 : Anthropic 探索用原则和 AI Feedback 训练安全助手
    2022 : ChatGPT 发布 : 对话式 AI Assistant 成为大众产品形态
    2023 : LLaMA 发布 : 强基座模型进入研究社区和本地部署生态
    2023 : GPT-4 发布 : 多模态、专业任务和安全评估成为前沿模型标配
    2023 : 文心一言与通义千问发布 : 中国大模型进入产品化竞争阶段
```
